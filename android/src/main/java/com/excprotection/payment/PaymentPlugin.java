...
public class PaymentPlugin  implements
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    if (call.method.equals("gethyperpayresponse")) {
      ...
      String type = call.argument("type");
        mode = call.argument("mode") != null ? call.argument("mode") : "test";
        Lang = call.argument("lang") != null ? call.argument("lang") : "en";
  ...
  private void openCheckoutUI(String checkoutId) {
    ...
    Set<String> paymentBrands = new LinkedHashSet<>(brandsReadyUi);
      if (checkoutId == null || paymentBrands == null || paymentBrands.isEmpty()) {
          error("CHECKOUT_SETTINGS_ERROR", "Invalid CheckoutSettings: checkoutId or brands missing", null);
          return;
      }
    ...
    intent.putExtra(CheckoutActivity.CHECKOUT_RECEIVER, componentName);
      ...
      if (activity == null) {
          error("ACTIVITY_NULL", "Activity context is null", null);
          return;
      }
  ...
  public boolean onNewIntent(@NonNull Intent intent) {
    // TO BACK TO VIEW
      if (intent.getScheme() != null && ShopperResultUrl != null &&
              intent.getDataString().startsWith(ShopperResultUrl)) {
          success("success");
    }
    return  true ;
  }
